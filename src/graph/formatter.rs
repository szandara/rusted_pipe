...
//     nodes: HashMap<String, Box<dyn Fn() -> Node>>,
// }

// impl NodeRegistry {
//     pub fn insert(&mut self, key: String, factory: Box<dyn Fn() -> Node>) {
...
//     impl Processor for GenericNode {
//         fn handle(
//             &mut self,
//             _input: crate::packet::PacketSet,
//             output: std::sync::Arc<std::sync::Mutex<crate::channels::WriteChannel>>,
//         ) -> Result<(), crate::RustedPipeError> {
//             output
//                 .lock()
//                 .unwrap()
//                 .write(
